    ...
    SampleAppMenuInterface
{
    ...
    private SeekBar scalebutton=null;
    private SeekBar translatebutton=null;
    public static float scalenum=0;
    public static float transnum=0;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        initbar();
        scalebutton=(SeekBar)findViewById(R.id.scale);
        translatebutton=(SeekBar) findViewById(R.id.translate);
        scalebutton.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            @Override
        ...
        translatebutton.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            @Override
            public void onProgressChanged(SeekBar seekBar, int i, boolean b) {
                transnum=i;
            }
    ...
    public boolean doLoadTrackersData()
    {
        ...
        if (!mCurrentDataset.load("ObjectRecognition/yersyu_OT.xml",
