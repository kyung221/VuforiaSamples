...
public class ObjectTargetRenderer implements GLSurfaceView.Renderer, SampleAppRendererControl
{
    ...
    public void renderFrame(State state, float[] projectionMatrix)
    {
        ...
        for (int tIdx = 0; tIdx < state.getNumTrackableResults(); tIdx++)
        {
            ...
            float s=ObjectTargets.scalenum*4/100;
            float t=ObjectTargets.transnum*4/100;

            Matrix.translateM(modelViewMatrix, 0, t*objectSize[0]/2, t*objectSize[1]/2,
                    t*objectSize[2]/2);
            
            Matrix.scaleM(modelViewMatrix, 0, s+objectSize[0]/2,
                    s+objectSize[1]/2, s+objectSize[2]/2);
            ...
            Log.e("abcde","rendering error?"+GLES20.glGetError());
